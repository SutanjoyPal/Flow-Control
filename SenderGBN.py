...
timeOut = 2
analysis_file_name = "C:/Users/Sutanjoy Pal/Desktop/Network lab/Computer-Networks/Assn2/GoBack_report.txt"
rttStore = []
...
class Sender:
    ...
    def sendData(self):
        ...
        #file = open(r"C:\Users\Sutanjoy Pal\Desktop\Network lab\Computer-Networks\Assn2\data.txt", 'r')
    ...
    def transmit(self):
        ...
        Analysis.printReport(self.name, self.receiver, analysis_file_name,
                             self.pktCount, self.totalPkt, totalTime, rttStore)
