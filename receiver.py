...
def my_receiver():
    print('Select Protocol for Receiving Data :-')
    ...
    with socket.socket() as client:
        ...
        while(True):
            ...
            for s in readable:
                ...
                if(data == "No client is available currently"):
                    print(data)
                    break
                elif(choice == 1):
                    ...
                    file_name = ''
                    if protocol == 0:
                        file_name = 'C:/Users/Sutanjoy Pal/Desktop/Flow-Control/StopWait_rec.txt'
                    elif protocol == 1:
                        file_name = 'C:/Users/Sutanjoy Pal/Desktop/Flow-Control/GoBack_rec.txt'
                    else:
                        file_name = 'C:/Users/Sutanjoy Pal/Desktop/Flow-Control/SelectiveRepeat_rec.txt'
